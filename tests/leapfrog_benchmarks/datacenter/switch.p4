...
parser Parser(packet_in pkt, out headers_t hdr) {
    ...
    state parse_udp {
        pkt.extract(hdr.udp);
        transition select(hdr.udp.data[31:16]) {
            (0xFFFF): parse_vxlan;
            default: accept;
        }
    }
    ...
    state parse_gre0 {
        ...
        transition select(hdr.gre0.data[2:2], hdr.gre0.data[31:16]) {
            (0x1, 0x6558): parse_nvgre;
            (0x1, 0x6559): parse_gre1;
            default: accept;
        }
    }
    ...
    state parse_gre1 {
        ...
        transition select(hdr.gre1.data[31:16]) {
            (0x16558): parse_nvgre;
            (0x16559): parse_gre2;
            default: accept;
        }
    ...
    state parse_gre2 {
        ...
        transition select(hdr.gre2.data[31:16]) {
            (0x16558): parse_nvgre;
            (0x16559): reject;
            default: accept;
        }
